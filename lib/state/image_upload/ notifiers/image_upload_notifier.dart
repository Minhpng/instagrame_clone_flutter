...
import 'package:instagram_clone_flutter/state/image_upload/exceptions/could_not_build_thumbnail_exception.dart';
import 'package:instagram_clone_flutter/state/image_upload/extensions/get_collection_name_from_file_type.dart';
import 'package:instagram_clone_flutter/state/image_upload/extensions/get_image_data_aspect_ratio.dart';
import 'package:instagram_clone_flutter/state/posts/models/post_payload.dart';
...
class ImageUploadNotifier extends StateNotifier<IsLoading> {
  ...
  Future<bool> upload({
    ...
    // caculate the aspect ratio of the thumbnail
    final thumbnailAspectRatio = await thumbnailUint8List.getImageAspectratio();

    final fileName = const Uuid().v4();

    // create references to the thumbnail and image ifself
